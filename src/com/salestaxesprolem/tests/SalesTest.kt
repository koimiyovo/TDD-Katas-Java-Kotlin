...
internal class SalesTest {
    ...
    fun `given 1 book at 12_49 then no tax is applied`() {
        ...
        Given(Basket(listOf(ONE_BOOK_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
                """1 book: 12.49
                    |Sales Taxes: 0.00
    ...
    fun `given 1 chocolate bar at 0_85 then no tax is applied`() {
        ...
        Given(Basket(listOf(ONE_CHOCOLATE_BAR_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
    ...
    fun `given 1 book at 12_49 and 1 chocolate bar at 0_85 then no tax is applied`() {
        ...
        Given(Basket(listOf(ONE_BOOK_NOT_IMPORTED, ONE_CHOCOLATE_BAR_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
                """1 book: 12.49
                    |1 chocolate bar: 0.85
    ...
    fun `given 1 music CD at 14_99 then the basic tax is applied`() {
        ...
        Given(Basket(listOf(ONE_MUSIC_CD_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
                """1 music CD: 16.49
                    |Sales Taxes: 1.50
    ...
    fun `given 2 music CD at 14_99 then the basic tax is applied`() {
        ...
        Given(Basket(listOf(TWO_MUSIC_CD_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
                """2 music CD: 32.98
                    |Sales Taxes: 3.00
    ...
    fun `test with 2 books and 1 music CD and 1 chocolate bar`() {
        ...
        Given(Basket(listOf(TWO_BOOKS_NOT_IMPORTED, ONE_MUSIC_CD_NOT_IMPORTED, ONE_CHOCOLATE_BAR_NOT_IMPORTED)))
            .whenPrintTicket()
            .thenTicketIs(
                """2 book: 24.98
                    |1 music CD: 16.49
    ...
    fun `given one imported product then import tax is applied`() {
        ...
        Given(Basket(listOf(ONE_IMPORTED_BOX_OF_CHOCOLATES_AT_10F)))
            .whenPrintTicket()
            .thenTicketIs(
    ...
    fun `test with 1 imported box of chocolates and 1 imported bottle of perfume`() {
        ...
        Given(Basket(listOf(ONE_IMPORTED_BOX_OF_CHOCOLATES_AT_10F, ONE_IMPORTED_BOTTLE_OF_PERFUME_AT_47_5F)))
            .whenPrintTicket()
            .thenTicketIs(
                """1 imported box of chocolates: 10.50
